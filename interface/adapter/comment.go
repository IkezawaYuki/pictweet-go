...
func (c *commentRepository) FindByID(id uint) (*dto.CommentDto, error) {
...
func (c *commentRepository) FindByTweetID(tweetID uint) (*dto.CommentsDto, error) {
	var comments dto.CommentsDto
...
func (c *commentRepository) FindAll() (*dto.CommentsDto, error) {
	var comments dto.CommentsDto
...
func (c *commentRepository) Create(comment *dto.CommentDto) error {
...
func (c *commentRepository) Update(comment *dto.CommentDto) error {
...
func (c *commentRepository) Delete(comment *dto.CommentDto) error {
